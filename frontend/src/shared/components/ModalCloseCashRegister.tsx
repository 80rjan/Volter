            ...
            <div className="flex flex-col gap-6 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#eee] z-[1000] p-8 rounded-lg min-w-[320px]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    {loading ? (
                        ...
                        <button
                            type="submit"
                            className="group relative overflow-hidden flex justify-center items-center gap-2 px-8 py-2 rounded bg-red-500 text-white text-lg shadow-[0_0_8px_rgba(0,0,0,0.2)] transition-all duration-300 hover:scale-105 active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed mt-2"
                        >
