...
export default function PeriodReport() {
  ...
  const getReport = (dateFrom, dateTo) => {
    ...
    axios
      .get(
        `http://localhost:3000/periodReport?dateFrom=${dateFrom}&dateTo=${dateTo}`
      )
      .then((res) => {
        setReport(res.data);
  ...
  return (
    <ReportPage>
      ...
      <Container>
        <HeaderWrapper>
          <h1>
            Периодичен Извештај <span>{showDate}</span>
          </h1>
          <div>
            <DateInput
              type="date"
            ...
            />
            <ButtonGetReport onClick={() => getReport(dateFrom, dateTo)}>
          ...
          <ContentWrapper>
            <MainReports>
                ...
                <div>
                  <h1>
                    {(
                      ...
                      Number(
                        report?.cashFlow?.find((c) => c.category === "Expense")
                          ?.moneyGiven || 0
                      )
              ...
              <MainReport>
                ...
                <div>
                  <h1>
                    {Number(report.total.moneyGiven).toLocaleString("de-DE")}
                  </h1>
              ...
              <MainReport>
                ...
                <div>
                  <h1>
                    {Number(report.numPawns.numTransactions).toLocaleString(
                      "de-DE"
                    )}
                  </h1>
                  <p>Нови залози</p>
              ...
              <MainReport>
                ...
                <div>
                  <h1>
                    {Number(report.numSales.numTransactions).toLocaleString(
                      "de-DE"
                    )}
                  </h1>
                  <p>Нови продажби</p>
                ...
                <CashFlowReports>
                  <CashFlowReport>
                    <div>
                      ...
                      {Number(report.transactions.length).toLocaleString(
                        "de-DE"
                      )}
                    </div>
                  </CashFlowReport>
