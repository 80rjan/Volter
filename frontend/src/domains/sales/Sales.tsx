...
import {Plus, ChevronUp, ChevronDown, Minus, Tag, Banknote, Gem, HandCoins, Coins} from "lucide-react";
        ...
        <div className="h-screen flex lg:pl-16 pt-12 lg:pt-0">
            <div className="flex flex-col px-3 md:px-8 pt-2 max-lg:landscape:pt-1 gap-3 max-lg:landscape:gap-1 flex-1 overflow-hidden">
                ...
                <div className="flex flex-col bg-white rounded-lg shadow-[0_0_8px_rgba(0,0,0,0.2)] overflow-x-auto flex-1 min-h-0">
                    ...
                    <div ref={scrollableSalesRef} className="overflow-y-auto overflow-x-hidden flex-1 scrollbar-thin min-w-[880px] md:min-w-0">
                ...
                <div className="flex w-full justify-between flex-wrap items-center gap-x-6 gap-y-1 bg-[#f4f4f4] border border-black/10 rounded-lg px-5 py-1.5 max-lg:landscape:py-0.5 text-xs text-[#666]">
                ...
                <MonthlyProfitBar refreshDependency={refresh} />
