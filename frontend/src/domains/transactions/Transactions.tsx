        ...
        <div className="h-screen flex lg:pl-16 pt-12 lg:pt-0">
            <div className="flex flex-col px-3 md:px-8 pt-2 max-lg:landscape:pt-1 gap-3 max-lg:landscape:gap-1 flex-1 overflow-hidden">
                {!allowed ? (
                    ...
                    <>
                        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-[2fr_2fr_2fr_2fr_1fr_1fr_.5fr] max-lg:landscape:grid-cols-[2fr_2fr_2fr_2fr_1fr_1fr_.5fr] w-full gap-2 md:gap-3">
                            <input
                                type="search"
