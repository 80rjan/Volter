...
<head>
    <title>Скит-2025/2026/L-48_46195: Ch06-ISP | COURSES</title>
    <link rel="shortcut icon" href="https://courses.finki.ukim.mk/theme/image.php/classic/theme/1782118036/favicon" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="moodle, Скит-2025/2026/L-48_46195: Ch06-ISP | COURSES" />
...
M.cfg = {"wwwroot":"https:\/\/courses.finki.ukim.mk","apibase":"https:\/\/courses.finki.ukim.mk\/r.php\/api","homeurl":{},"sesskey":"j66EuKjWgs","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1782118036","slasharguments":1,"theme":"classic","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1782118036","admin":"admin","svgicons":true,"usertimezone":"Europe\/Skopje","language":"en","courseId":3002,"courseContextId":302701,"contextid":305124,"contextInstanceId":171060,"langrev":1782118036,"templaterev":"1782118036","siteId":1,"userId":14670};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<body  id="page-mod-resource-view" class="format-weeks  path-mod path-mod-resource safari dir-ltr lang-en yui-skin-sam yui3-skin-sam courses-finki-ukim-mk pagelayout-incourse course-3002 context-305124 cmid-171060 cm-type-resource category-41 theme ">
...
//]]>
    ...
    <div class="popover-region-toggle nav-link icon-no-margin"
        ...
        aria-controls="popover-region-container-6a47a0a6e9f246a47a0a6db39f41"
        aria-haspopup="true"
        aria-expanded="false"
    ...
    <div 
        id="popover-region-container-6a47a0a6e9f246a47a0a6db39f41"
    ...
    <a
        id="message-drawer-toggle-6a47a0a6eb9a06a47a0a6db39f42"
        ...
        role="button"
        aria-expanded="false"
        aria-describedby="unread-messages-count-6a47a0a6eb9a06a47a0a6db39f42"
    >
        ...
        >
            ...
            <span class="sr-only" id="unread-messages-count-6a47a0a6eb9a06a47a0a6db39f42">There are 0 unread conversations</span>
        </div>
    </a>
    ...
    <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171060"
                        aria-current="page"
                        title="File"
                ...
                <div id="region-main" class="region-main-content">
                    <span class="notifications" id="user-notifications"></span>
                        ...
                        <div class="activity-header" data-for="page-activity-header">
                                ...
                                <div data-region="activity-information" data-activityname="Ch06-ISP" class="activity-information">


</div>
</div>
                    <div role="main"><div class="resourcecontent resourcepdf">
     <iframe id="resourceobject" src="https://courses.finki.ukim.mk/pluginfile.php/305124/mod_resource/content/1/i_3058d737/ch06-isp.pdf" title="Ch06-ISP" width="800" height="600">
         Click <a href="https://courses.finki.ukim.mk/pluginfile.php/305124/mod_resource/content/1/i_3058d737/ch06-isp.pdf" >ch06-isp.pdf</a> link to view the file.
     </iframe>
</div></div>
                    <div class="mt-5 mb-1 activity-navigation container-fluid">
<div class="row">
    <div class="col-md-4">        <div class="float-start">
                <a href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171058&forceview=1" id="prev-activity-link" class="btn btn-link" >&#x25C0;&#xFE0E; Ch05-criteria</a>

        </div>
</div>
    <div class="col-md-4">        <div class="mdl-align">
            <div class="urlselect">
    <form method="post" action="https://courses.finki.ukim.mk/course/jumpto.php" class="d-flex flex-wrap align-items-center" id="url_select_f6a47a0a6db39f52">
    ...
    <div class="col-md-4">        <div class="float-end">
                <a href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171061&forceview=1" id="next-activity-link" class="btn btn-link" >Ch07-1-2-GraphCoverage &#x25B6;&#xFE0E;</a>
...
<section id="inst3641"
    ...
    <div class="card-body p-3">
        ...
        <div class="card-text content mt-3">
            <ul class="block_tree list" role="tree" data-ajax-loader="block_navigation/nav_loader"><li class="type_unknown depth_1 contains_branch" role="treeitem" aria-expanded="true" aria-owns="random6a47a0a6db39f3_group" data-collapsible="false" aria-labelledby="random6a47a0a6db39f2_label_1_1"><p class="tree_item branch navigation_node"><a tabindex="-1" id="random6a47a0a6db39f2_label_1_1" href="https://courses.finki.ukim.mk/">Home</a></p><ul id="random6a47a0a6db39f3_group" role="group"><li class="type_setting depth_2 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f4_label_2_2"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f4_label_2_2" href="https://courses.finki.ukim.mk/my/"><i class="icon fa fa-gauge fa-fw navicon" aria-hidden="true" ></i><span class="item-content-wrap">Dashboard</span></a></p></li><li class="type_course depth_2 contains_branch" role="treeitem" aria-expanded="false" aria-owns="random6a47a0a6db39f6_group" aria-labelledby="random6a47a0a6db39f4_label_2_3"><p class="tree_item branch"><span tabindex="-1" id="random6a47a0a6db39f4_label_2_3" title="СИСТЕМ ЗА КУРСЕВИ НА ФИНКИ">Site pages</span></p><ul id="random6a47a0a6db39f6_group" role="group" aria-hidden="true"><li class="type_custom depth_3 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f7_label_3_5"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f7_label_3_5" href="https://courses.finki.ukim.mk/my/courses.php"><i class="icon fa fa-square fa-fw navicon" aria-hidden="true" ></i><span class="item-content-wrap">My courses</span></a></p></li><li class="type_setting depth_3 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f7_label_3_6"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f7_label_3_6" href="https://courses.finki.ukim.mk/tag/search.php"><i class="icon fa fa-square fa-fw navicon" aria-hidden="true" ></i><span class="item-content-wrap">Tags</span></a></p></li><li class="type_activity depth_3 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f7_label_3_8"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f7_label_3_8" title="Forum" href="https://courses.finki.ukim.mk/mod/forum/view.php?id=173"><img class="icon navicon" alt="Forum" title="Forum" src="https://courses.finki.ukim.mk/theme/image.php/classic/forum/1782118036/monologo" /><span class="item-content-wrap">Site news</span></a></p></li></ul></li><li class="type_system depth_2 contains_branch" role="treeitem" aria-expanded="true" aria-owns="random6a47a0a6db39f11_group" aria-labelledby="random6a47a0a6db39f4_label_2_9"><p class="tree_item branch canexpand"><a tabindex="-1" id="random6a47a0a6db39f4_label_2_9" href="https://courses.finki.ukim.mk/my/courses.php">My courses</a></p><ul id="random6a47a0a6db39f11_group" role="group"><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_1663" data-node-key="1663" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_10"><p class="tree_item branch" id="expandable_branch_20_1663"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_10" title="Консултации" href="https://courses.finki.ukim.mk/course/view.php?id=1663">Консултации</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_263" data-node-key="263" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_11"><p class="tree_item branch" id="expandable_branch_20_263"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_11" title="Студентски информативен центар" href="https://courses.finki.ukim.mk/course/view.php?id=263">SIC</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2981" data-node-key="2981" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_12"><p class="tree_item branch" id="expandable_branch_20_2981"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_12" title="Human-computer interaction design-2025/2026/L" href="https://courses.finki.ukim.mk/course/view.php?id=2981">Hid-2025/2026/L-48_35099</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2968" data-node-key="2968" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_13"><p class="tree_item branch" id="expandable_branch_20_2968"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_13" title="Агентно-базирани системи-2025/2026/L" href="https://courses.finki.ukim.mk/course/view.php?id=2968">Ас-2025/2026/L-48_42903</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_3010" data-node-key="3010" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_14"><p class="tree_item branch" id="expandable_branch_20_3010"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_14" title="Интегрирани системи-2025/2026/L" href="https://courses.finki.ukim.mk/course/view.php?id=3010">Ис-2025/2026/L-48_42892</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2972" data-node-key="2972" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_15"><p class="tree_item branch" id="expandable_branch_20_2972"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_15" title="Континуирана интеграција и испорака-2025/2026/L" href="https://courses.finki.ukim.mk/course/view.php?id=2972">Киии-2025/2026/L-48_42910</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_3009" data-node-key="3009" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_16"><p class="tree_item branch" id="expandable_branch_20_3009"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_16" title="Напредни бази на податоци-Advanced Databases-2025/2026/L" href="https://courses.finki.ukim.mk/course/view.php?id=3009">AdvDB-2025/2026/L-48_42915</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="true" aria-owns="random6a47a0a6db39f13_group" aria-labelledby="random6a47a0a6db39f12_label_3_17"><p class="tree_item branch canexpand"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_17" title="Софтверски квалитет и тестирање/ Software Quality and Testing -2025/2026/L" href="https://courses.finki.ukim.mk/course/view.php?id=3002">Скит-2025/2026/L-48_46195</a></p><ul id="random6a47a0a6db39f13_group" role="group"><li class="type_container depth_4 contains_branch" role="treeitem" aria-expanded="false" aria-owns="random6a47a0a6db39f15_group" aria-labelledby="random6a47a0a6db39f14_label_4_18"><p class="tree_item branch"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_18" href="https://courses.finki.ukim.mk/user/index.php?id=3002">Participants</a></p><ul id="random6a47a0a6db39f15_group" role="group" aria-hidden="true"><li class="type_user depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f16_label_5_19"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f16_label_5_19" href="https://courses.finki.ukim.mk/user/view.php?id=14670&amp;course=3002"><i class="icon fa fa-square fa-fw navicon" aria-hidden="true" ></i><span class="item-content-wrap">Борјан Ѓорѓиевски</span></a></p></li></ul></li><li class="type_setting depth_4 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f14_label_4_20"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_20" href="https://courses.finki.ukim.mk/admin/tool/lp/coursecompetencies.php?courseid=3002"><i class="icon fa fa-list-check fa-fw navicon" aria-hidden="true" ></i><span class="item-content-wrap">Competencies</span></a></p></li><li class="type_setting depth_4 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f14_label_4_21"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_21" href="https://courses.finki.ukim.mk/grade/report/index.php?id=3002"><i class="icon fa fa-clipboard-check fa-fw navicon" aria-hidden="true" ></i><span class="item-content-wrap">Grades</span></a></p></li><li class="type_structure depth_4 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_30_47922" data-node-key="47922" data-node-type="30" aria-labelledby="random6a47a0a6db39f14_label_4_22"><p class="tree_item branch" id="expandable_branch_30_47922"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_22" href="https://courses.finki.ukim.mk/course/section.php?id=47922">General</a></p></li><li class="type_structure depth_4 contains_branch" role="treeitem" aria-expanded="true" aria-owns="random6a47a0a6db39f20_group" aria-labelledby="random6a47a0a6db39f14_label_4_23"><p class="tree_item branch"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_23" href="https://courses.finki.ukim.mk/course/section.php?id=47923">Предавања/ Lectures</a></p><ul id="random6a47a0a6db39f20_group" role="group"><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_24"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_24" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171052"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Introduction to the subject</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_25"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_25" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171053"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Вовед во предметот</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_27"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_27" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171055"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch01-whyTest</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_28"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_28" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171056"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch02-mdtd</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_29"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_29" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171057"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch04-agiletest</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_30"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_30" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171058"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch05-criteria</span></a></p></li><li class="type_activity depth_5 item_with_icon current_branch" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_31"><p class="tree_item hasicon active_tree_node"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_31" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171060"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch06-ISP</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_32"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_32" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171061"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch07-1-2-GraphCoverage</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_33"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_33" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171062"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch07-3-sourceCode</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_34"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_34" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171059"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Testing in the lifecycle</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_36"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_36" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171064"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch08-1-overviewLogicExpr</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_37"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_37" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171065"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch08-3-sourceLogic</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_38"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_38" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171066"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">User Interface (UI) Testing</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_39"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_39" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171067"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">API Testing</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_40"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_40" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171068"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch09-1-overviewSyntax</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_41"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_41" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171069"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Ch09-2-source-active</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_42"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_42" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171070"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Bug Reporting</span></a></p></li><li class="type_activity depth_5 item_with_icon" role="treeitem" aria-labelledby="random6a47a0a6db39f21_label_5_43"><p class="tree_item hasicon"><a tabindex="-1" id="random6a47a0a6db39f21_label_5_43" title="File" href="https://courses.finki.ukim.mk/mod/resource/view.php?id=171071"><img class="icon navicon" alt="File" title="File" src="https://courses.finki.ukim.mk/theme/image.php/classic/core/1782118036/f/pdf" /><span class="item-content-wrap">Managing the Test Process</span></a></p></li></ul></li><li class="type_structure depth_4 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_30_47924" data-node-key="47924" data-node-type="30" aria-labelledby="random6a47a0a6db39f14_label_4_44"><p class="tree_item branch" id="expandable_branch_30_47924"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_44" href="https://courses.finki.ukim.mk/course/section.php?id=47924">Вежби/ Exercises</a></p></li><li class="type_structure depth_4 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_30_47925" data-node-key="47925" data-node-type="30" aria-labelledby="random6a47a0a6db39f14_label_4_45"><p class="tree_item branch" id="expandable_branch_30_47925"><a tabindex="-1" id="random6a47a0a6db39f14_label_4_45" href="https://courses.finki.ukim.mk/course/section.php?id=47925">Лабораториски вежби / Lab exercises</a></p></li></ul></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2884" data-node-key="2884" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_46"><p class="tree_item branch" id="expandable_branch_20_2884"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_46" title="Бази на податоци-2025/2026/Z" href="https://courses.finki.ukim.mk/course/view.php?id=2884">БП-2025/2026</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2873" data-node-key="2873" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_47"><p class="tree_item branch" id="expandable_branch_20_2873"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_47" title="Вовед во науката за податоци-2025/2026/Z" href="https://courses.finki.ukim.mk/course/view.php?id=2873">ВНП-2025/26</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2842" data-node-key="2842" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_48"><p class="tree_item branch" id="expandable_branch_20_2842"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_48" title="Дизајн и архитектура на софтвер-Software Design and Architecture 2025/2026/Z" href="https://courses.finki.ukim.mk/course/view.php?id=2842">ДАС SDA 2025-2026</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2855" data-node-key="2855" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_49"><p class="tree_item branch" id="expandable_branch_20_2855"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_49" title="Напредно програмирање-2025/2026/Z" href="https://courses.finki.ukim.mk/course/view.php?id=2855">Нп-2025/2026/Z-47_46190</a></p></li><li class="type_course depth_3 contains_branch" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false" data-node-id="expandable_branch_20_2831" data-node-key="2831" data-node-type="20" aria-labelledby="random6a47a0a6db39f12_label_3_50"><p class="tree_item branch" id="expandable_branch_20_2831"><a tabindex="-1" id="random6a47a0a6db39f12_label_3_50" title="Обработка на природните јазици-2025/2026/Z" href="https://courses.finki.ukim.mk/course/view.php?id=2831">Онпј-2025/2026/Z-47_30764</a></p></li></ul></li></ul></li></ul>
  ...
  <span id="sb-1"></span></aside>
    ...
    <div
    id="drawer-6a47a0a6edbb16a47a0a6db39f53"
    ...
    tabindex="-1"
            aria-modal="true"
        aria-labelledby="message-drawer-header-6a47a0a6edbb16a47a0a6db39f53"

>
            <div id="message-drawer-6a47a0a6edbb16a47a0a6db39f53" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-6a47a0a6edbb16a47a0a6db39f53"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-6a47a0a6edbb16a47a0a6db39f53"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-6a47a0a6edbb16a47a0a6db39f53"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-6a47a0a6edbb16a47a0a6db39f53"
                                        class="nav-link"
                                        href="#requests-tab-panel-6a47a0a6edbb16a47a0a6db39f53"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-6a47a0a6edbb16a47a0a6db39f53"
                                        aria-selected="false"
                                    >
                                        Requests
                    ...
                    data-user-id="14670"
                                        id="contacts-tab-panel-6a47a0a6edbb16a47a0a6db39f53"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-6a47a0a6edbb16a47a0a6db39f53"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="14670"
                                        id="requests-tab-panel-6a47a0a6edbb16a47a0a6db39f53"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-6a47a0a6edbb16a47a0a6db39f53"
                ...
                >
                    ...
                    <div id="message-drawer-view-overview-container-6a47a0a6edbb16a47a0a6db39f53" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-6a47a0a6edbb16a47a0a6db39f53"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-6a47a0a6edbb16a47a0a6db39f53"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="14670"
                                            id="view-overview-favourites-target-6a47a0a6edbb16a47a0a6db39f53"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-6a47a0a6edbb16a47a0a6db39f53"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-start p-1 p-sm-2 d-flex rounded-0 align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-6a47a0a6edbb16a47a0a6db39f53"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-6a47a0a6edbb16a47a0a6db39f53"
                                    >
                                        <span class="collapsed-icon-container">
                                            <span class="dir-rtl-hide"><i class="icon fa fa-chevron-right fa-fw " aria-hidden="true" ></i></span>
                                            <span class="dir-ltr-hide"><i class="icon fa fa-chevron-left fa-fw " aria-hidden="true" ></i></span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="14670"
                                            id="view-overview-group-messages-target-6a47a0a6edbb16a47a0a6db39f53"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-start p-1 p-sm-2 d-flex rounded-0 align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-6a47a0a6edbb16a47a0a6db39f53"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-6a47a0a6edbb16a47a0a6db39f53"
                                    >
                                        <span class="collapsed-icon-container">
                                            <span class="dir-rtl-hide"><i class="icon fa fa-chevron-right fa-fw " aria-hidden="true" ></i></span>
                                            <span class="dir-ltr-hide"><i class="icon fa fa-chevron-left fa-fw " aria-hidden="true" ></i></span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="14670"
                                            id="view-overview-messages-target-6a47a0a6edbb16a47a0a6db39f53"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-6a47a0a6edbb16a47a0a6db39f53-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ms-2" for="block-noncontacts-6a47a0a6edbb16a47a0a6db39f53-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-6a47a0a6edbb16a47a0a6db39f53-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ms-2" for="block-noncontacts-6a47a0a6edbb16a47a0a6db39f53-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-6a47a0a6edbb16a47a0a6db39f53" >
                                    <label class="custom-control-label" for="enter-to-send-6a47a0a6edbb16a47a0a6db39f53">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
...
function(
    ...
    var toggle = $('#message-drawer-toggle-6a47a0a6eb9a06a47a0a6db39f42');
    Popover.init(toggle);
});
;
        ...
        require(['jquery', 'core/custom_interaction_events'], function($, CustomEvents) {
            ...
            $('#jump-to-activity').on(CustomEvents.events.accessibleChange, function() {
                if ($(this).val()) {
                    $('#url_select_f6a47a0a6db39f52').submit();
                }
            });
        });
    ;
...
require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-6a47a0a6edbb16a47a0a6db39f53');
    MessageDrawer.init(root, '6a47a0a6edbb16a47a0a6db39f53', false);
});
;
...
;
M.util.js_pending('core/notification'); require(['core/notification'], function(amd) {amd.init(305124, []); M.util.js_complete('core/notification');});;
...
<script>
//<![CDATA[
(function() { M.util.js_pending('random6a47a0a6db39f1'); Y.on('domready', function() { M.util.init_maximised_embed(Y, "resourceobject");  M.util.js_complete('random6a47a0a6db39f1'); });
M.util.help_popups.setup(Y);
 M.util.js_pending('random6a47a0a6db39f54'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random6a47a0a6db39f54'); });
})();
//]]>
</script>
