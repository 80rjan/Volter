...
import com.volter.backend.pawn.domain.model.event.*;
import com.volter.backend.pawn.domain.repository.PawnRepository;
import com.volter.backend.pawn.application.dto.PawnCreationRequest;
import com.volter.backend.pawn.application.dto.PawnModificationRequest;
import com.volter.backend.pawn.domain.model.enums.PawnStatus;
import com.volter.backend.pawn.infrastructure.PawnMapper;
import com.volter.backend.pawn.domain.model.enums.PawnEventType;
import com.volter.backend.sale.domain.model.Sale;
import com.volter.backend.sale.application.SaleService;
