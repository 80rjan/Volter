package com.volter.backend.item.domain.model;

import com.volter.backend.item.domain.model.details.ElectronicItemDetails;
import com.volter.backend.item.domain.model.details.GoldItemDetails;
...
import com.volter.backend.item.domain.model.details.OtherItemDetails;
import com.volter.backend.pawn.domain.model.Pawn;
import com.volter.backend.sale.domain.model.Sale;
import com.volter.backend.item.domain.model.details.VehicleItemDetails;
import com.volter.backend.item.domain.model.details.WatchItemDetails;
