package com.volter.shop.modules.alert.domain.model;
...
@Table(
        indexes = {
                @Index(name = "idx_risk_alert_created_at", columnList = "createdAt DESC"),
                @Index(name = "idx_risk_alert_read_by_manager_created_at", columnList = "readByManager, createdAt DESC"),
                @Index(name = "idx_risk_alert_type_created_at", columnList = "type, createdAt DESC"),
                @Index(name = "idx_risk_alert_severity_created_at", columnList = "severity, createdAt DESC"),
        }
)
